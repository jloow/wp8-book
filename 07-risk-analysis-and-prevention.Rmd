...
Risk assessments can be performed in number of ways, depending on the situation and circumstances. All risk assessment should however be based on probability and consequences of unwanted events. A practical tool for this purpose is a risk matrix that eases a systematic and consequent risk assessment; see @fig:tablea

![Risk matrix based on probability and consequences.](./media/tab-matrix.png){#fig:tablea}

As seen in @fig:tablea, probability is expressed as a frequency for a specific event or deviation. During planning, the assessed risk level can also be coupled to a specified need for action; see @fig:tableb

![Risk level and need for action during planning.](./media/risk-level-planning.png){#fig:tableb}

The risk matrix for risk assessments during planning can also, with some modification, be used for risk assessments in the operative production stages (@fig:tablec). The risk matrix has therefore become a quite well known and used tool in mining companies.

![Risk level and need for action during production.](./media/risk-level-production.png){#fig:tablec}
